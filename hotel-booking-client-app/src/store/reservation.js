...
const useRoomStore = defineStore("reservation", {
  state: () => ({
    message: "",
    records: [],
    record: null,
  ...
  actions: {
    async fetchRecords() {
      try {
        ...
        const request = await axios.get(`${generalStore.API_URL}reservation`, {
          headers: {
    ...
    async fetchRecordById(id) {
      ...
      const userStore = useUserStore();
      const token = userStore.token;
      const getAPI = `${generalStore.API_URL}reservation/${id}`;
    ...
    async editRecord(isEditCheck, form) {
      ...
      const userStore = useUserStore();
      const token = userStore.token;
      const addAPI = `${generalStore.API_URL}reservation`;
      const editAPI = `${generalStore.API_URL}reservation/${form.id}`;
    ...
    async deleteRecord(id) {
      ...
      const userStore = useUserStore();
      const token = userStore.token;
      const deleteAPI = `${generalStore.API_URL}reservation/${id}`;
